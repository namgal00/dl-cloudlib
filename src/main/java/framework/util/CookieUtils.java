...
import framework.constant.CookieConstant;
...
public class CookieUtils {
	...
	public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value) {
		addCookie(request, response, name, value, null, CookieConstant.cookiePath, CookieConstant.cookieDomain, null);
	}
	...
	public static void removeCookie(HttpServletRequest request, HttpServletResponse response, String name) {
		removeCookie(request, response, name, CookieConstant.cookiePath, CookieConstant.cookieDomain);
	}
}
