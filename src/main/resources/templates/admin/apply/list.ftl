			...
			<div class="pubTable">
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						...
						<td>
							<div title="${data.budget }">${data.budget }</div>
						</td>
						<td>
							<div title="${data.schoolId }">${data.schoolId }</div>
						</td>
						<td>
							<div title="${data.contact }">${data.contact }</div>
						</td>
						<td>
							<div title="${data.contactWay }">${data.contactWay }</div>
						</td>
