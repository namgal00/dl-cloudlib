...
<!-- 删除
	...
	<script type="text/javascript" src="./js/jquery/jquery.easyui.extend.js"></script>
	<script type="text/javascript" src="./js/jquery/jquery-ui-1.8.22.custom.min.js"></script>
	<script type="text/javascript" src="./js/jquery/jquery-hashchange/jquery.ba-hashchange.min.js"></script>
...
<div class="w1024 fc">
<!-- 删除
<link href="./文津搜索_files/easyui.css" rel="stylesheet" type="text/css">
-->
	<div id="l_wjLogo"><a href="http://find.nlc.cn/"></a><img src="/front/images/logo1.png" onload="fix(this)"></div>
		...
		<div class="advanceSearch_bd">
			...
			<fieldset>
				<div class="document_type">
					<label>指定文献类型：</label>
					<select name="criteria-docTypeSlt" id="docTypeSlt" onchange="setFieldSlt(this);"><option value="图书">图书</option><option value="古文献">古文献</option><option value="论文">论文</option><option value="期刊报纸">期刊报纸</option><option value="多媒体">多媒体</option><option value="缩微文献">缩微文献</option><option value="文档">文档</option><option value="词条">词条</option></select>
				</div>
			</fieldset>
			...
			<fieldset id="criteriaFieldSet">
				...
				<div class="blk5"></div>
					<div id="logicSearchTab">
						<div class="item fn-clear">
							<div class="feeds fl">
								<select class="w120 fieldSlt" name="criteria-fieldSlt-0" id="fieldSlt-0"><option value="全部字段">全部字段</option><option value="题名">题名</option><option value="责任者">责任者</option><option value="关键词">关键词</option><option value="出版商">出版商</option><option value="ISBN">ISBN</option></select>
							</div>
							<div class="feeds fl">
								<p>
									<input type="text" maxlength="60" class="inputTxt w408" name="criteria-criteriaIpt-0" id="criteriaIpt-0">
								</p>
								<p class="translate" toen="翻译成英文" toch="翻译成中文"><a href="javascript:void(0);" onclick="translate2zh(this)">翻译成中文</a>&nbsp;-&nbsp;&nbsp;<a href="javascript:void(0);" onclick="translate2en(this)">翻译成英文</a></p>
							</div>
							<div class="feeds fl">
								<p>
				...
				<div class="item fn-clear" style="display:none" id="fullTextSearchTab">
					...
					<option value="全部字段">全部字段</option><option value="题名">题名</option><option value="责任者">责任者</option><option value="关键词">关键词</option><option value="出版商">出版商</option><option value="ISBN">ISBN</option></select>
					</div>
					<div class="feeds fl">
						<p>
