...
<html>
				...
				<div class="bd_hd">
					<div class="s_wjSearch fn-clear">
						<div id="w_logo" class="w_logo" >
							<a href=""><img src="${base}/front/images/logo2.png" /></a>
						</div>
					...
					<div class="sideFilter fn-clear fl" id="searchresult-sidebar">
						...
						<div class="item">
							...
							<ul class="mNav" curarea="mediaType">
								...
								<li class="b">
									<a class="b_t" href="javascript:void(0);" mattr="V" title="航空、航天"><span><label><input type="checkbox" aid="V" class="inputCheck mr5"><b>V类(航空、航天)</b></label></span></a>
								</li>
								<li class="b">
									<a class="b_t" href="javascript:void(0);" mattr="X" title="环境科学、安全科学"><span><label><input type="checkbox" aid="X" class="inputCheck mr5"><b>X类(环境科学、安全科学)</b></label></span></a>
								</li>
								<li class="b">
	...
	<span><b>1</b>/9300</span>
							...
							<div id="resultitem-box">
								...
								<div id="searchresult-items">
									...
									<div class="item">
										<div class="num">1.</div>
										<div class="img">
											<a href="javascript:void(0);" onclick="" target="_blank"><img src="${base}/front/images/0.jpg"></a>
										</div>
		...
		华文网公司
									...
									<div class="page">
										<a href="javascript:void(turnSearchResultPage(2));" class="pre">上一叶</a>
