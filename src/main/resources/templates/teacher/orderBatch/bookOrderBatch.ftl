...
<script src="${base }/teacher/js/WdatePicker.js" type="text/javascript"></script><link href="js/WdatePicker.css" rel="stylesheet" type="text/css">
	...
	<p class="close1" onclick="closeHelp();" style="margin-top: 340px;">关闭</p>
				...
				<div class="list_table_title">
					...
					<ul>
						...
						<li><span class="btn_left"></span><a href="${base }/teacher/batch/addBatch" class="btn btn_new">新增</a><span class="btn_right"></span></li>
						<li><font></font></li>
