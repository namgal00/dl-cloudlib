							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tbody>
									...
									<tr>
										...
										<td align="left"><input name="budget" type="text" value="" id="budget" onblur="textOnBlur()"><span style="color: red" id="budgetInfo">*</span></td>
									</tr>

									<tr>
										<th align="right" width="150">联系人：</th>
										<td align="left"><input name="contact" type="text" value="" id="contact" onblur="textOnBlur()"><span style="color: red" id="contactInfo">*</span></td>
									</tr>

									<tr>
										<th align="right" width="150">联系方式：</th>
										<td align="left"><input name="contactWay" type="text" value="" id="contactWay" onblur="textOnBlur()"><span style="color: red" id="contactWayInfo">*</span></td>
									</tr>
									...
									<tr>
										<th align="right">&nbsp;</th>
										<td><input name="" class="input_btn" type="button" value="保存" onclick="judgeSubmit()"> <input name="" class="input_btn" type="reset" value="重置" onclick="formReset()"> <input name="" class="input_btn" type="button" value="返回" onclick="javascript:history.go(-1);"></td>
									</tr>
								</tbody>
							</table>
						</div>
