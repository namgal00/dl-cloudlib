...
<!-- js -->
<script src="${base }/teacher-newjs/jquery-1.8.2.min.js" type="text/javascript"></script>
...
<script src="${base }/teacher-new/js/WdatePicker.js" type="text/javascript"></script>
