...
<link rel="shortcut icon"
	href="${base }/teacher-new/images/favicon.ico" />
...
<link href="${base }/teacher-new/css/frame.css"
	rel="stylesheet" type="text/css" />
<link href="${base }/teacher-new/css/smartMenu.css"
	rel="stylesheet" type="text/css" />
<!-- js -->
<script src="${base }/teacher-new/js/jquery-1.8.2.min.js"
	type="text/javascript"></script>
<script type="text/javascript"
	src="${base }/teacher-new/js/jquery.textSearch-1.0.js">
        </script>
<script src="${base }/teacher-new/js/marc/jquery-smartMenu.js"
	type="text/javascript"></script>
<script src="${base }/teacher-new/js/marc/ZeroClipboard.js"
	type="text/javascript"></script>
<script src="${base }/teacher-new/js/common_list.js"
	type="text/javascript"></script>
<script
	src="${base }/teacher-new/js/calendar/WdatePicker.js"
	type="text/javascript"></script>
<script type="text/javascript">
	var base = "/cloudlib";
	function closeHelp() {
...
<body>
	<form action="/cloudlib/biblioTemp/list"
...
<link rel="stylesheet"
	href="${base }/teacher-new/css/dialog.css"
	type="text/css" />
<script type="text/javascript">
	$(function() {
				...
				<div class="search">
					<div class="search_condition">
						<span><font>ISBN：</font> <input name="isbn" type="text" id="isbn"
							...
							value="" /></span> <span
							class="search_button"
							onclick="doFormSubmit('formId','/cloudlib/biblioTemp/query')">
							<input name="" type="button" value="查询" class="btn_orange" />
						</span> <span class="search_button"
							onclick="doFormSubmit('formId','/cloudlib/z3950DownLoad/z3950Query')">
				...
				<div class="list_table_title">
					...
					<ul>
						...
						<li><span class="btn_left"></span><a
							href="javascript:remove('/cloudlib/biblioTemp/delete/#id#')"
							class="btn btn_delete">批量订购</a><span class="btn_right"></span></li>
						<li><font></font></li>
					</ul>
				</div>
						...
						<tbody>
								...
								<tr>
									<td align="right"><input name="checks"
										type="checkbox" class="input_none" id="checks" value="10048589"/></td>
									<td>1817-3586&nbsp;</td>
									<td>I247&nbsp;</td>
									<td>小说贩(2005.12)&nbsp;</td>
									<td>本社编&nbsp;</td>
									...
									<td><a href="${base }/teachernew/bookOrder/order">查看</a></td>
								</tr>
							
								<input name="ids" type="hidden" value="10048588" />
								<tr>
									<td align="right"><input name="checks"
										type="checkbox" class="input_none" id="checks" value="10048588"/></td>
									<td>7-204-05545-4&nbsp;</td>
									<td>I247&nbsp;</td>
									<td>官运亨通&nbsp;</td>
									<td>程凌征著&nbsp;</td>
								...
								<tr>
									<td align="right"><input name="checks"
										type="checkbox" class="input_none" id="checks" value="10048587"/></td>
									<td>7-5317-1875-8&nbsp;</td>
									<td>I247&nbsp;</td>
									<td>歌哭&nbsp;</td>
									<td>漆漆著&nbsp;</td>
								...
								<tr>
									<td align="right"><input name="checks"
										type="checkbox" class="input_none" id="checks" value="10048586"/></td>
									<td>7-204-05545-4&nbsp;</td>
									<td>I247&nbsp;</td>
									<td>位高权重&nbsp;</td>
									<td>程凌征著&nbsp;</td>
								...
								<tr>
									<td align="right"><input name="checks"
										type="checkbox" class="input_none" id="checks" value="10048585"/></td>
									<td>7-5012-2921-X&nbsp;</td>
									<td>K825&nbsp;</td>
									<td>搜索张朝阳&nbsp;</td>
									<td>天宇著&nbsp;</td>
