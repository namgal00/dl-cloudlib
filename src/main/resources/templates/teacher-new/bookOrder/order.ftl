...
<script src="${base }/teacher-new/js/jquery-smartMenu.js"
	type="text/javascript"></script>
<script src="${base }/teacher-new/js/ZeroClipboard.js"
	type="text/javascript"></script>
<script src="${base }/teacher-new/js/common_list.js"
	type="text/javascript"></script>
<script
	src="${base }/teacher-new/js/WdatePicker.js"
	type="text/javascript"></script>
<script type="text/javascript">
	var base = "";
	function closeHelp() {
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="2" align="left" valign="middle" height="20"
									class="list_table_bg_hover"><input name="" class="input_btn" type="button" value="编目"
											onclick="location.href='/bookOrder/findOneBiblio/801469'" /></td>
							</tr>
					...
					<div class="row_half_right2">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input name="curprice" type="text"
									value="19.8" /></td>
							...
							<tr>
								...
								<td width="35%" align="left"><input name="copies"
									type="text" id="copies" /></td>
							...
							<tr>
								...
								<td align="left"><select name="currency" id="sourceType">
							...
							<tr>
								...
								<td colspan="3" align="left"><textarea name="remark"
									...
									<tr>
										<td class="td_graybg" colspan="4"><input name=""
											class="input_btn" type="button" value="保存"
											onclick="order('/bookOrder/order')" />
											<input name="" class="input_btn" type="button" value="重置"
											onclick="formReset()" /> <input name="" class="input_btn"
											type="button" value="返回"
											onclick="doReturn('/bookOrder/listSellerBiblio/301')" /></td>
									</tr>
